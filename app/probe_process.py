"""Independent kube probe process for secflow-app-dataflow-vuln-scan."""
...
SERVICE_NAME = os.environ.get("SECFLOW_PROBE_SERVICE_NAME", "secflow-app-dataflow-vuln-scan")
